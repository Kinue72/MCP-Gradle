...
import tech.mania.ui.util.ColorUtil;
...
public class TTFFontRenderer {
    ...
    public static TTFFontRenderer of(String resource, int size) {
        try {
            //System.out.println(TTFFontRenderer.class.getClassLoader().getResourceAsStream("assets/mania/font/" + resource + ".ttf"));
            return new TTFFontRenderer(
                    Font.createFont(
                            Font.TRUETYPE_FONT,
                            Objects.requireNonNull(TTFFontRenderer.class.getClassLoader().getResourceAsStream("assets/mania/font/" + resource + ".ttf"))
    ...
    private TTFFontRenderer(Font font, boolean fractionalMetrics, boolean antialiasing, boolean international) {
    ...
    public TTFFontRenderer(final Font font, final boolean fractionalMetrics, final boolean antialiasing) {
        this.antialiasing = antialiasing;
        this.font = font;
        this.fractionalMetrics = fractionalMetrics;
        this.fontHeight = (float) (font.getStringBounds(ALPHABET, new FontRenderContext(new AffineTransform(), antialiasing, fractionalMetrics)).getHeight() / 2);
